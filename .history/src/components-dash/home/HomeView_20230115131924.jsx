    ...
    return(
        <div style={{width:'100%'}}>
                ...
                <div className="accordion__cont">
                    ...
                    <div className="card2">
                    <iframe style="background: #FFFFFF;border: none;border-radius: 2px;box-shadow: 0 2px 10px 0 rgba(70, 76, 79, .2);" width="640" height="480" src="https://charts.mongodb.com/charts-project-0-ihsbu/embed/charts?id=63c3d16f-5398-4ce5-8d41-6e83f43166f8&maxDataAge=3600&theme=light&autoRefresh=true"></iframe>
                    </div>
                </div>
